...
==================================== */
	...
	==================================== */
		...
		$to = "thomasperron92@gmail.com"; // Your email goes here	
		$subject = "Request";
		$headers = "From: Thomas Perron <thomasperron92@gmail.com>";
		...
		echo '<br>';
		echo '<a class="mry-btn mry-default-link mry-anima-link" href="index.html">Accueil</a>';
		echo '</div>';
	} else {
